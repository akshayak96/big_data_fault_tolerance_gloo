...
void RedisStore::set(const std::string& key, const std::vector<char>& data) {
  std::cout << "setting key-value for redis store" << std::endl;
...
std::vector<char> RedisStore::get(const std::string& key) {
  std::cout << "getting key-value for redis store" << std::endl;
...
bool RedisStore::check(const std::vector<std::string>& keys) {
  std::cout << "checking keys for redis store" << std::endl;
...
void RedisStore::wait(
  ...
  std::cout << "performing wait for redis store" << std::endl;  
